...
#define WM_USER_IMG_PATH (WM_USER + 1)
...
public:
	BEGIN_MSG_MAP(CImgWnd)
		...
		MESSAGE_HANDLER(WM_USER_IMG_PATH, OpenImage)
	END_MSG_MAP()
...
private:
	...
	LRESULT		OpenImage(UINT uMsg, WPARAM wParam, LPARAM lParam, BOOL& bHandled) noexcept;
};